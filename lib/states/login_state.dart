...
import 'package:teragate/services/permission_service.dart';
                          ...
                          _createGestureDetector(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text('ID Check', style: textStyle.copyWith(fontSize: 16)),
  ...
  TextFormField _initTextFormField(bool isObscureText, TextEditingController controller, String message, TextStyle style, String decorationType) {
    return TextFormField(
        ...
        decoration: decorationType == "Id"
            ? InputDecoration(filled: true, fillColor: boxColor, prefixIcon: Image.asset('assets/person_outline_black_24dp.png', fit: BoxFit.scaleDown), labelText: "ID", labelStyle: textFieldStyle, border: const OutlineInputBorder())
            : InputDecoration(filled: true, fillColor: boxColor, prefixIcon: Image.asset('assets/lock_open_black_24dp.png', fit: BoxFit.scaleDown), labelText: "Password", labelStyle: textFieldStyle, border: const OutlineInputBorder()));
  }
