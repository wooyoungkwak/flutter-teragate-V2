...
class SettingState extends State<Setting> {
  ...
  //         TextSpan(text: Env.TITLE_SETTING_UUID, recognizer: TapGestureRecognizer()..onTapDown = (details) async {}, style: textStyle.copyWith(fontSize: 18, fontWeight: FontWeight.w700)),
  //       ]),
  //     ),
  //   ]);
  // }
